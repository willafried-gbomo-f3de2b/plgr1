...
add_custom_command(TARGET ${TARGETNAME}
	...
	COMMAND ${CMAKE_COMMAND} ${SRCDIR}/flac -D BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} ${CFLAG} ${CXXFLAG} $<$<BOOL:${CMAKE_BUILD_TYPE}>:"-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}"> ${ARCHOPT} -D WITH_OGG=OFF -D BUILD_CXXLIBS=OFF -D BUILD_PROGRAMS=OFF -D BUILD_EXAMPLES=OFF -D BUILD_DOCS=OFF -D INSTALL_MANPAGES=OFF -D BUILD_TESTING=OFF 
