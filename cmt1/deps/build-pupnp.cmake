...
add_custom_command(TARGET ${TARGETNAME}
	...
	COMMAND ${CMAKE_COMMAND} ${SRCDIR}/pupnp -D BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} ${CFLAG} ${CXXFLAG} $<$<BOOL:${CMAKE_BUILD_TYPE}>:"-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}"> ${ARCHOPT} -D samples=OFF -D  DOWNLOAD_AND_BUILD_DEPS=OFF -D BUILD_TESTING=OFF -D ipv6=OFF -D PTHREADS4W_DIR=$${BLDDIR}/out/lib/cmake 
