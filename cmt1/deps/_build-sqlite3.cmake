...
add_custom_command(TARGET ${TARGETNAME}
	...
	COMMAND ${CMAKE_COMMAND} -P ${SRCDIR}/sqlite3.cmake -D BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} ${CFLAG} ${CXXFLAG} $<$<BOOL:${CMAKE_BUILD_TYPE}>:"-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}"> ${ARCHOPT}
