...
add_custom_command(TARGET ${TARGETNAME}
	...
	COMMAND ${CMAKE_COMMAND} ${SRCDIR}/libmatroska -D BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} ${CFLAG} ${CXXFLAG} -D EBML_DIR=${DSTDIR}/${CMAKE_INSTALL_LIBDIR}/cmake/EBML $<$<BOOL:${CMAKE_BUILD_TYPE}>:"-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}"> ${ARCHOPT}
